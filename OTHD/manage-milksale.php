...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_GET['del'])) {
        ...
        $query = mysqli_query($con, "delete from tblmsale where id='$cmpid'");
        echo "<script>alert('Milk Sale record deleted.');</script>";
...
?>
    ...
    <head>
        ...
        <title>Manage Milk Sale Information</title>
        <!-- Data Table CSS -->
            ...
            <div class="hk-pg-wrapper ml-0">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Milk Sale Information</h4>
                        <a href="add-milksale.php"><button class="btn btn-danger ">Add Milk Sale</button></a>
                    </div>
                    <!-- /Title -->
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "select * from tblmsale");
                                                    $cnt = 1;
