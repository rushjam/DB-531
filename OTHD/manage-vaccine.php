...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if(isset($_REQUEST['id'])) {
        ...
        $query1 = "DELETE FROM `tblvaccine` WHERE id=".$_REQUEST['id'];
...
?>
    ...
    <head>
        ...
        <title>Manage Vaccine Information</title>
        <!-- Data Table CSS -->
            ...
            <div class="hk-pg-wrapper ml-0">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Vaccine Information</h4>
                        <a href="add-vaccine.php"><button class="btn btn-danger">Add Vaccine Record</button></a>
                    </div>
                    <!-- /Title -->
                                        ...
                                        <div class="table-wrap">
                                            <table id="example" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "select * from tblvaccine");
                                                    $cnt = 1;
