...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblmcoll set CollectionID='$cidn',CowNumber='$cownumber',Date='$date',Pound='$pound',Price='$priceperpound',Total='$total' where id='$cid'");
        echo "<script>alert('Milk Sale updated successfully.');</script>";
...
?>
    ...
    <head>
        ...
        <title>Milk Sale Category</title>
            ...
            <div class="hk-pg-wrapper ml-0">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit Milk Sale</h4>
                    </div>
                    <!-- /Title -->
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form class="needs-validation" method="post" novalidate>
                                            <?php
                                            $pid = substr(base64_decode($_GET['pid']), 0, -5);
                                            $ret = mysqli_query($con, "select * from tblmsale where ID='$pid'");
                                            $cnt = 1;
                                            ...
                                            ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        <label for="validationCustom03">Collection Number</label>
                                                        <input type="number" class="form-control" id="validationCustom03" value="<?php echo $row['Collection Number']; ?>" name="cidn" required>
                                                        <div class="invalid-feedback">Please provide a valid IDr.</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['Cow Number']; ?>" name="cownumber" required>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['Date']; ?>" name="date" required>
