...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_GET['del'])) {
        ...
        $query = mysqli_query($con, "delete from tblmcoll where id='$cmpid'");
        echo "<script>alert('Milk Collection record deleted.');</script>";
...
?>
    ...
    <head>
        ...
        <title>Manage Milk Collection Information</title>
        <!-- Data Table CSS -->
                                        ...
                                        <div class="table-wrap">
                                            <table id="example" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "select * from tblmcoll");
                                                    $cnt = 1;
